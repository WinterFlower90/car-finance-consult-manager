package com.pje.carfinanceconsultmanager.configure;
...
public class SwaggerConfig {
    ...
    private final String TITLE_FIX = "차량 금융 상담 관리 API ";
    ...
    public Docket apiV1() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName(version)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.pje.carfinanceconsultmanager"))
